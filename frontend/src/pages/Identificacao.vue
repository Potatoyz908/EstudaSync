...
<template>
  <div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-600 to-blue-500 p-4">
    <div class="w-full max-w-md bg-white rounded-xl shadow-xl overflow-hidden">
      <div class="p-8">
        ...
        <h1 class="text-3xl font-extrabold text-center text-gray-800 mb-2">Bem-vindo!</h1>
        <p class="text-center text-gray-500 mb-8">Entre no EstudaSync para acompanhar seu progresso.</p>
